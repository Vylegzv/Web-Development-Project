...
if($action == 'ajax'){
  ...
  /*
	...
	*/
	...
	$query = mysql_query("SELECT * FROM smallpets WHERE type = 'Rabbit' ");
...
<html>
  <head>
	...
	?>
    <title>Small Pets World: Rabbit</title>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="keywords"  content="small pets, rabbit, care guide, how to" />
    <meta name="description" content="A pet owner's guide to rabbits" />
	...
	function load(page){
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'rabbit.php?action=ajax&page='+page,
  ...
  <body>
	...
	<?php
		$result = mysql_query("SELECT * FROM smallpets WHERE Type = 'Rabbit'", $db);
    //loop through fetched data
