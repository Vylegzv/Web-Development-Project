...
if($action == 'ajax'){
  ...
  /*
	$count_query   = mysql_query("SELECT COUNT(*) AS numrows FROM smallpets WHERE type = 'Hamster'");
	...
	*/
	...
	$query = mysql_query("SELECT * FROM smallpets WHERE type = 'Hamster' ");
...
<html>
  <head>
	...
	?>
    <title>Small Pets World: Hamster</title>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="keywords"  content="small pets, hamster, care guide, how to" />
    <meta name="description" content="A pet owner's guide to hamsters" />
	...
	function load(page){
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'hamster.php?action=ajax&page='+page,
  ...
  <body>
	...
	<?php
		$result = mysql_query("SELECT * FROM smallpets WHERE Type = 'hamster'", $db);
    //loop through fetched data
