...
if($action == 'ajax'){
  ...
  /*
	...
	*/
	...
	$query = mysql_query("SELECT * FROM smallpets WHERE type = 'Ferret' ");
...
<html>
  <head>
	...
	?>
    <title>Small Pets World: Ferret</title>
    <meta http-equiv="content-type" content="text/html; charset=utf-8" />
    <meta name="keywords"  content="small pets, ferret, care guide, how to" />
    <meta name="description" content="A pet owner's guide to ferrets" />
	...
	function load(page){
		$("#loader").fadeIn('slow');
		$.ajax({
			url:'ferret.php?action=ajax&page='+page,
  ...
  <body>
	...
	<?php
		$result = mysql_query("SELECT * FROM smallpets WHERE Type = 'Ferret'", $db);
    //loop through fetched data
